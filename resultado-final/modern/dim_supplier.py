...
LINAJE (WWI real): Purchasing.Suppliers + Purchasing.SupplierCategories + Application.People (contacto).
REGLAS: join proveedor + categoría + contacto; surrogate [Supplier Key]. SCD2 en el legacy;
aquí estado actual. Ver legacy_sql/MigrateStagedSupplierData.sql.
"""
import duckdb
